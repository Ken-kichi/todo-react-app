      ...
      <form onSubmit={handleSubmit}>
        <div>
          <input
            type="text"
            required
            className="my-2 rounded border border-gray-300 px-3 py-2 text-sm placeholder-slate-500 focus:border-indigo-500 focus:outline-none"
            placeholder="Email"
            value={email}
            onChange={(e) => {
        ...
        <div className="my-6 flex items-center justify-center text-sm">
          <span
            ...
            className="cursor-pinter font-medium hover:text-indigo-500"
          >
            change mode ?
          </span>
        </div>
